...
function Table({ cols, rows, actions, selectable }) {
  return (
    <div className="banking-table-wrap">
      <div className="table-responsive" style={{ overflowX: 'auto', width: '100%', WebkitOverflowScrolling: 'touch' }}><table className="banking-table">
