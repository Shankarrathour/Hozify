...
export default function PartnerBanking() {
  ...
  return (
    <AdminShell
      ...
      pageTitle="Banking & Settlement Center"
      pageSubtitle="Manage partner banking profiles, settlement cycles, payout processing and financial compliance."
    >
