...
export default function BSPPartners() {
  ...
  return (
    <AdminShell
      ...
      pageTitle="Business Service Providers"
      pageSubtitle="Manage onboarding, KYC verification, settlements, compliance and performance across all registered BSPs."
    >
            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-200 hover:bg-slate-50 transition"
                >
                  <Download size={16} />
                  Export
                </button>
